# The Owner's Tour: what manyworldz actually is, in plain English
...
> "manyworldz is a forecasting engine. Instead of asking one AI a question, it
...
`engine/whatif.py` lets you inject a fact, like "treat as true: the star
player is out," and re-run the crowd. You watch the probability move. That's the
